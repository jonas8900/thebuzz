        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed top-10 left-1/2 -translate-x-1/2 bg-white dark:bg-gray-800 border border-red-500 rounded-2xl shadow-xl p-4 flex items-center space-x-3 z-9999"
                >
